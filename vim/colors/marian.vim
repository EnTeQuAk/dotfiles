...
" ===================
"
" Author: Marian Sigler <mariansigler@gmail.com>
" Based on fruity by Armin Ronacher <armin.ronacher@active-4.com>
"
...
" Window Elements
hi StatusLine   guifg=#ffffff guibg=#8090a0 gui=bold ctermbg=gray ctermfg=black
...
hi LineNr       guifg=#aaaaaa   guibg=#222222   ctermfg=darkgray

" Specials
hi Todo         guifg=#FFAE2E   guibg=#000000   gui=bold 
hi Title        guifg=#ffffff                   gui=bold
hi Special      guifg=#fd8900

" Syntax Elements
hi String       guifg=#AAD3FF	ctermfg=darkblue    
hi Constant     guifg=#729FCF
hi Number       guifg=#89A8CA                   
hi Statement    guifg=#FCDD00   ctermfg=darkyellow                 
hi Function     guifg=#FFCC00                   
hi PreProc      guifg=#A9004A                   gui=bold
hi Comment      guifg=#A1B2A0   ctermfg=gray    gui=italic
hi Type         guifg=#cdcaa9                   "gui=bold
hi Error        guifg=#ffffff   guibg=#222222
hi Identifier   guifg=#E6E6E6                   "gui=bold
hi Label        guifg=#9F1616
...
hi pythonCoding 	guifg=#A1D0B2 	ctermfg=gray
hi pythonRun    	guifg=#A1D0B2	ctermfg=gray
...
hi pythonFunction   	guifg=#EF2929   ctermfg=darkred   
hi pythonClass      	guifg=#ff0086              
hi pythonString     	guifg=#AAD3FF	ctermfg=darkblue
hi pythonEscape    	guifg=#AAD3FF 	ctermfg=darkblue
hi pythonStrFormat 	guifg=#AAFFEE	ctermfg=darkblue
